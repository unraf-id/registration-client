...
public class RegistrationUIConstants {
	...
	public static final String INVALID_UNRAF_ID="ID UNIVERSITARIO NO VÁLIDO";
	...
	public static final String UPDATE_UNRAFID_VALIDATION_ALERT = "UPDATE_UNRAFID_VALIDATION_ALERT";
