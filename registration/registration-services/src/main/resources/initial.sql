...
CREATE TABLE "REG"."MACHINE_SPEC" ("ID" VARCHAR(36) NOT NULL, "NAME" VARCHAR(64) NOT NULL, "BRAND" VARCHAR(32) NOT NULL, "MODEL" VARCHAR(16) NOT NULL, "MTYP_CODE" VARCHAR(36) NOT NULL, "MIN_DRIVER_VER" VARCHAR(16) NOT NULL, "DESCR" VARCHAR(256), "LANG_CODE" VARCHAR(3), "IS_ACTIVE" BOOLEAN NOT NULL, "CR_BY" VARCHAR(32) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(32), "UPD_DTIMES" TIMESTAMP, "IS_DELETED" BOOLEAN, "DEL_DTIMES" TIMESTAMP);
...
CREATE TABLE "REG"."USER_DETAIL" ("ID" VARCHAR(36) NOT NULL, "NAME" VARCHAR(64) NOT NULL, "EMAIL" VARCHAR(64), "MOBILE" VARCHAR(16), "STATUS_CODE" VARCHAR(64), "LANG_CODE" VARCHAR(3) NOT NULL, "LAST_LOGIN_DTIMES" TIMESTAMP, "LAST_LOGIN_METHOD" VARCHAR(36), "UNSUCCESSFUL_LOGIN_COUNT" SMALLINT, "USERLOCK_TILL_DTIMES" TIMESTAMP, "IS_ACTIVE" BOOLEAN NOT NULL, "CR_BY" VARCHAR(32) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(32), "UPD_DTIMES" TIMESTAMP, "IS_DELETED" BOOLEAN, "DEL_DTIMES" TIMESTAMP, "REG_ID" VARCHAR(36), "SALT" VARCHAR(64), "REG_CNTR_ID" VARCHAR(10) NOT NULL);

CREATE TABLE "REG"."GLOBAL_PARAM" ("CODE" VARCHAR(128) NOT NULL, "NAME" VARCHAR(128) NOT NULL, "VAL" VARCHAR(1024), "TYP" VARCHAR(128) NOT NULL, "LANG_CODE" VARCHAR(3) NOT NULL, "IS_ACTIVE" BOOLEAN NOT NULL, "CR_BY" VARCHAR(32) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(32), "UPD_DTIMES" TIMESTAMP, "IS_DELETED" BOOLEAN, "DEL_DTIMES" TIMESTAMP);

CREATE TABLE "REG"."REGISTRATION" ("ID" VARCHAR(39) NOT NULL, "REG_TYPE" VARCHAR(64) NOT NULL, "REF_REG_ID" VARCHAR(39), "PREREG_ID" VARCHAR(64),"APP_ID" VARCHAR(128) NOT NULL, "PACKET_ID" VARCHAR(256) NOT NULL, "ADDITIONAL_INFO_REQ_ID" VARCHAR(128), "STATUS_CODE" VARCHAR(36) NOT NULL, "LANG_CODE" VARCHAR(3) NOT NULL, "STATUS_COMMENT" VARCHAR(256), "STATUS_DTIMES" TIMESTAMP, "ACK_FILENAME" VARCHAR(128), "CLIENT_STATUS_CODE" VARCHAR(36), "SERVER_STATUS_CODE" VARCHAR(256), "CLIENT_STATUS_DTIME" TIMESTAMP, "SERVER_STATUS_DTIME" TIMESTAMP, "CLIENT_STATUS_COMMENT" VARCHAR(256), "SERVER_STATUS_COMMENT" VARCHAR(256), "REG_USR_ID" VARCHAR(36) NOT NULL, "REGCNTR_ID" VARCHAR(10) NOT NULL, "APPROVER_USR_ID" VARCHAR(36) NOT NULL, "APPROVER_ROLE_CODE" VARCHAR(36), "FILE_UPLOAD_STATUS" VARCHAR(64), "UPLOAD_COUNT" SMALLINT, "UPLOAD_DTIMES" TIMESTAMP, "LATEST_REGTRN_ID" VARCHAR(36), "LATEST_TRN_TYPE_CODE" VARCHAR(36), "LATEST_TRN_STATUS_CODE" VARCHAR(36), "LATEST_TRN_LANG_CODE" VARCHAR(3), "LATEST_REGTRN_DTIMES" TIMESTAMP, "IS_ACTIVE" BOOLEAN NOT NULL, "CR_BY" VARCHAR(32) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(32), "UPD_DTIMES" TIMESTAMP, "ADDITIONAL_INFO" BLOB(2147483647), "ACK_SIGNATURE" VARCHAR(350), "HAS_BWORDS" BOOLEAN);
...
CREATE TABLE "AUDIT"."APP_AUDIT_LOG" ("LOG_ID" VARCHAR(64) NOT NULL, "LOG_DTIMES" TIMESTAMP NOT NULL, "LOG_DESC" VARCHAR(2048), "EVENT_ID" VARCHAR(64) NOT NULL, "EVENT_TYPE" VARCHAR(64) NOT NULL, "EVENT_NAME" VARCHAR(128) NOT NULL, "ACTION_DTIMES" TIMESTAMP NOT NULL, "HOST_NAME" VARCHAR(32) NOT NULL, "HOST_IP" VARCHAR(16) NOT NULL, "SESSION_USER_ID" VARCHAR(64) NOT NULL, "SESSION_USER_NAME" VARCHAR(128), "APP_ID" VARCHAR(64) NOT NULL, "APP_NAME" VARCHAR(128) NOT NULL, "MODULE_ID" VARCHAR(64), "MODULE_NAME" VARCHAR(128), "REF_ID" VARCHAR(64), "REF_ID_TYPE" VARCHAR(64), "CR_BY" VARCHAR(256) NOT NULL);

CREATE TABLE "REG"."USER_PWD" ("USR_ID" VARCHAR(36) NOT NULL, "PWD" VARCHAR(512), "PWD_EXPIRY_DTIMES" TIMESTAMP, "STATUS_CODE" VARCHAR(64) NOT NULL, "LANG_CODE" VARCHAR(3) NOT NULL, "IS_ACTIVE" BOOLEAN NOT NULL, "CR_BY" VARCHAR(32) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(32), "UPD_DTIMES" TIMESTAMP, "IS_DELETED" BOOLEAN, "DEL_DTIMES" TIMESTAMP);

CREATE TABLE "REG"."BLOCKLISTED_WORDS" ("WORD" VARCHAR(128) NOT NULL, "DESCR" VARCHAR(256), "LANG_CODE" VARCHAR(3) NOT NULL, "IS_ACTIVE" BOOLEAN NOT NULL, "CR_BY" VARCHAR(32) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(32), "UPD_DTIMES" TIMESTAMP, "IS_DELETED" BOOLEAN, "DEL_DTIMES" TIMESTAMP);

CREATE TABLE "REG"."MACHINE_MASTER" ("ID" VARCHAR(10) NOT NULL, "NAME" VARCHAR(64) NOT NULL, "MAC_ADDRESS" VARCHAR(64), "SERIAL_NUM" VARCHAR(64), "IP_ADDRESS" VARCHAR(17), "PUBLIC_KEY" CLOB(2147483647) NOT NULL, "KEY_INDEX" VARCHAR(128) NOT NULL, "VALIDITY_END_DTIMES" TIMESTAMP, "MSPEC_ID" VARCHAR(36) NOT NULL, "LANG_CODE" VARCHAR(3), "IS_ACTIVE" BOOLEAN NOT NULL, "REG_CNTR_ID" VARCHAR(10) NOT NULL, "CR_BY" VARCHAR(256) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(256), "UPD_DTIMES" TIMESTAMP, "IS_DELETED" BOOLEAN, "DEL_DTIMES" TIMESTAMP);
...
CREATE TABLE "REG"."DYNAMIC_FIELD" ("ID" VARCHAR(36) NOT NULL, "NAME" VARCHAR(36) NOT NULL, "DESCRIPTION" VARCHAR(256), "DATA_TYPE" VARCHAR(16), "VALUE_JSON" CLOB, "LANG_CODE" VARCHAR(3) NOT NULL, "IS_ACTIVE" BOOLEAN NOT NULL);
...
CREATE TABLE "REG"."REGISTRATION_TRANSACTION" ("ID" VARCHAR(36) NOT NULL, "REG_ID" VARCHAR(39) NOT NULL,"APP_ID" VARCHAR(39) NOT NULL, "TRN_TYPE_CODE" VARCHAR(36) NOT NULL, "REMARKS" VARCHAR(1024), "PARENT_REGTRN_ID" VARCHAR(36), "STATUS_CODE" VARCHAR(36) NOT NULL, "LANG_CODE" VARCHAR(3) NOT NULL, "STATUS_COMMENT" VARCHAR(1024), "CR_BY" VARCHAR(32) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(32), "UPD_DTIMES" TIMESTAMP, "IS_DELETED" BOOLEAN, "DEL_DTIMES" TIMESTAMP);

CREATE TABLE "REG"."KEY_POLICY_DEF" ("APP_ID" VARCHAR(36) NOT NULL, "KEY_VALIDITY_DURATION" SMALLINT, "IS_ACTIVE" BOOLEAN NOT NULL, "PRE_EXPIRE_DAYS" SMALLINT, "ACCESS_ALLOWED" VARCHAR(1024), "CR_BY" VARCHAR(256) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(256), "UPD_DTIMES" TIMESTAMP, "IS_DELETED" BOOLEAN, "DEL_DTIMES" TIMESTAMP);

CREATE TABLE "REG"."KEY_ALIAS" ("ID" VARCHAR(36) NOT NULL, "APP_ID" VARCHAR(36) NOT NULL, "REF_ID" VARCHAR(128), "KEY_GEN_DTIMES" TIMESTAMP, "KEY_EXPIRE_DTIMES" TIMESTAMP, "STATUS_CODE" VARCHAR(36), "LANG_CODE" VARCHAR(3), "UNI_IDENT" VARCHAR(50), "CR_BY" VARCHAR(256) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(256), "UPD_DTIMES" TIMESTAMP, "IS_DELETED" BOOLEAN, "DEL_DTIMES" TIMESTAMP, "CERT_THUMBPRINT" VARCHAR(128));
...
CREATE TABLE "REG"."MACHINE_TYPE" ("CODE" VARCHAR(36) NOT NULL, "NAME" VARCHAR(64) NOT NULL, "DESCR" VARCHAR(128), "LANG_CODE" VARCHAR(3), "IS_ACTIVE" BOOLEAN NOT NULL, "CR_BY" VARCHAR(32) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(32), "UPD_DTIMES" TIMESTAMP, "IS_DELETED" BOOLEAN, "DEL_DTIMES" TIMESTAMP);
...
CREATE TABLE "REG"."SYNC_JOB_DEF" ("ID" VARCHAR(36) NOT NULL, "NAME" VARCHAR(64) NOT NULL, "API_NAME" VARCHAR(64), "PARENT_SYNCJOB_ID" VARCHAR(36), "SYNC_FREQ" VARCHAR(36), "LOCK_DURATION" VARCHAR(36), "LANG_CODE" VARCHAR(3), "IS_ACTIVE" BOOLEAN NOT NULL, "CR_BY" VARCHAR(32) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(32), "UPD_DTIMES" TIMESTAMP, "IS_DELETED" BOOLEAN, "DEL_DTIMES" TIMESTAMP, "JOB_TYPE" VARCHAR(128));

CREATE TABLE "REG"."USER_TOKEN" ("USR_ID" VARCHAR(36) NOT NULL, "TOKEN" VARCHAR(2048), "TOKEN_EXPIRY" BIGINT, "REFRESH_TOKEN" VARCHAR(2048), "RTOKEN_EXPIRY" BIGINT, "IS_ACTIVE" BOOLEAN NOT NULL, "CR_BY" VARCHAR(32) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(32), "UPD_DTIMES" TIMESTAMP);
...
ALTER TABLE "REG"."BLOCKLISTED_WORDS" ADD CONSTRAINT "PK_BLWRD_CODE" PRIMARY KEY ("WORD", "LANG_CODE");

ALTER TABLE "REG"."REGISTRATION_TRANSACTION" ADD CONSTRAINT "PK_REGTRN_ID" PRIMARY KEY ("ID");

ALTER TABLE "REG"."USER_TOKEN" ADD CONSTRAINT "PK_USRTOKEN_USR_ID" PRIMARY KEY ("USR_ID");
